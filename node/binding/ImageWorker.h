...
public:
    ...
    ImageWorker(Napi::Env env,  std::shared_ptr<ImageCached> &image, unsigned int &width, unsigned int &height) : Napi::AsyncWorker(env), mImageRef(image),
                                                                                                             _height(height),
                                                                                                             _width(width)
    {
    }
...
private:
    ...
    std::shared_ptr<ImageCached> &mImageRef;
    unsigned int &_width;
